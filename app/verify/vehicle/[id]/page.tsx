    ...
    <div className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-4 py-12">
      <div className="luxury-panel rounded-[2rem] p-8 text-center">
        ...
        <p className="mt-4 text-sm text-white/60">
          معرّف السيارة: <span className="font-mono text-[#d6a84f]" dir="ltr">{decoded}</span>
        </p>
        <p className="mt-4 text-sm leading-relaxed text-white/50">
          رمز QR مرتبط بمركبة مسجّلة في النظام. للاطلاع على المواصفات والسعر والحالة، استخدم لوحة التحكم بعد
          تسجيل الدخول.
        </p>
